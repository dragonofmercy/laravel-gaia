@if(\Illuminate\Support\Facades\Request::ajax())
    ...
    <div class="modal-body text-center p-5">
        <div class="fs-error text-gray-400 fw-bold">404</div>
        <p class="fs-2 fw-bold">@lang('gui::errors.404.title')</p><hr>
        <div class="fs-4 text-gray-500">@lang('gui::errors.404.clue')</div>
        <div class="gui-hidden-without-modal">
            <button type="button" class="btn btn-primary btn-lg mt-5 mx-auto col-6" data-bs-dismiss="modal">@lang('gui::errors.404.close')</button>
        </div>
    </div>
